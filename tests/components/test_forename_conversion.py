...
@pytest.mark.parametrize('sentence_pair,expected_sentence_pair', [
    (
            ...
            ['Unfortunately, Leonardos handy was stuck in Giulias flytrap.', 'Purtroppo, Leonardos Handy è rimasto bloccato '
                                                                     'nella trappola per mosche di Giulia.']
    ),
    (
    ...
    (
            ...
            ['Leonardo told Aurora that Alessandro wanted to ask Giulia for a razor.', 'Leonardo disse a Aurora che Alessandro '
                                                                            'voleva chiedere ad Giulia un rasoio.']
    ),
    (
